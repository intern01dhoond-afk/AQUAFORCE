  ...
  return (
    <section className="relative overflow-hidden bg-white w-full">
      ...
      <div className="md:hidden flex flex-col items-center text-center py-10 px-4 w-full">
        {/* Title & Subtitle */}
        <h2 className="text-[#0e1726] text-[32px] font-black uppercase tracking-tight leading-[1.08]">
          WASH WITHOUT
          <br />
          LIMITS
        </h2>
        ...
        {/* Subtitle */}
        <p className="text-[#8892a0] text-xs font-bold tracking-[0.24em] uppercase mb-6">
          AQUAFORCE 1400
        </p>
        ...
        <div className="flex flex-col items-center gap-2.5 w-full max-w-sm">
          ...
          <div className="flex items-center justify-center gap-2 w-full">
            <span className="border-[1.5px] border-[#0e1726] rounded-[8px] px-3.5 py-1.5 text-[#0e1726] text-[11px] font-black uppercase tracking-wider bg-transparent">
              NO SOCKET
            </span>
            <span className="border-[1.5px] border-[#0e1726] rounded-[8px] px-3.5 py-1.5 text-[#0e1726] text-[11px] font-black uppercase tracking-wider bg-transparent">
              NO CABLES
          ...
          <div className="flex items-center justify-center gap-2">
            <span className="border-[1.5px] border-[#0e1726] rounded-[8px] px-5 py-1.5 text-[#0e1726] text-[11px] font-black uppercase tracking-wider bg-transparent">
              SWITCH ON
            </span>
            <span className="border-[1.5px] border-[#0e1726] rounded-[8px] px-5 py-1.5 text-[#0e1726] text-[11px] font-black uppercase tracking-wider bg-transparent">
              WASH
      ...
      <div className="hidden md:grid grid-cols-12 w-full min-h-[460px] lg:min-h-[520px]">
        ...
        <div className="md:col-span-4 bg-white flex flex-col items-center justify-center text-center px-6 sm:px-8 py-12 md:py-8 z-10 shadow-xs">
          {/* Main Title */}
          <h2 className="text-[#0e1726] text-3xl sm:text-4xl lg:text-[40px] font-black uppercase tracking-tight leading-[1.08]">
            WASH WITHOUT
            <br />
            LIMITS
          </h2>
          ...
          {/* Subtitle */}
          <p className="text-slate-500 text-[11px] sm:text-xs font-bold tracking-[0.22em] uppercase mb-8">
            AQUAFORCE 1400
          </p>
