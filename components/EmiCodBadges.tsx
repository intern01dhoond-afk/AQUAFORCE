...
export default function EmiCodBadges({ className = "" }: EmiCodBadgesProps) {
  return (
    <div
      className={`inline-flex items-center bg-white rounded-full p-[3px] shadow-md select-none ${className}`}
    >
      {/* Left Light Blue Pill: Available Options */}
      <div className="bg-[#8cc8ff] text-[#0f5c9e] font-bold text-[11px] xs:text-[12px] sm:text-[13px] px-3.5 py-1 rounded-full shrink-0 flex items-center">
