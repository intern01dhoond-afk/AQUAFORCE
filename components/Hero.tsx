      ...
      >
        ...
        <div className="sm:hidden relative z-10 w-full h-full flex flex-col justify-end px-5 pb-10 pt-20">
          ...
          <div className="mt-3.5 w-full">
            <button
              onClick={openModal}
              className="w-full inline-flex items-center justify-center gap-2 bg-[#0066cc] hover:bg-[#0052b3] text-white font-inter text-xs font-black tracking-wider uppercase py-3.5 rounded-[4px] shadow-xl shadow-blue-600/30 transition-all active:scale-[0.98] cursor-pointer"
            >
              <span>SHOP NOW</span>
              <ArrowRight className="w-4 h-4 shrink-0" />
            </button>
        ...
        <div className="hidden sm:flex relative z-10 w-full px-6 sm:px-12 lg:px-16 xl:px-20 pt-28 pb-16 sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-28 h-full flex-col justify-center">
          <div className="max-w-[620px] lg:max-w-[760px] xl:max-w-[820px]">
            ...
            <div className="mt-6 sm:mt-7">
              <button
                onClick={openModal}
                className="inline-flex items-center gap-2 bg-[#0066cc] hover:bg-[#0052b3] text-white font-inter text-xs sm:text-sm font-black tracking-wider uppercase px-7 py-3.5 rounded-[4px] shadow-xl shadow-blue-600/30 transition-all hover:scale-105 active:scale-95 cursor-pointer"
              >
                <span>SHOP NOW</span>
                <ArrowRight className="w-4 h-4 shrink-0" />
              </button>
