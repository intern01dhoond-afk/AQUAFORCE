...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* ========================================================= */}
      {/* SLIDE 1: Center Machine Driveway Banner (pressure washer Banner_ 3 Y.png) */}
      {/* ========================================================= */}
      <div
      ...
      >
        ...
        <div className="sm:hidden absolute inset-0 z-0">
          <Image
            ...
            alt="AMEC Aquaforce 1400 Driveway Washing Scene"
            fill
            priority
            sizes="100vw"
            className="object-cover object-center"
          />
          {/* Bottom Dark Gradient for mobile text readability */}
        ...
        <div className="hidden sm:block absolute inset-0 z-0">
          <Image
            ...
            className="object-cover object-center"
          />
          {/* Bottom Dark Gradient for desktop readability */}
        ...
        {/* Desktop Slide 1 Bottom Content Bar */}
      ...
      {/* ========================================================= */}
      {/* SLIDE 2: Patio SUV Foam Scene (pressure washer Banner_ 1 B.png) */}
      {/* ========================================================= */}
      <div
        className={`absolute inset-0 transition-opacity duration-700 ease-in-out ${
          currentSlide === 1
      ...
      {/* ========================================================= */}
      {/* SLIDE 3: Adventure Motorbike Washing Scene (pressure washer Banner_ 4Y.png) */}
      {/* ========================================================= */}
      <div
        className={`absolute inset-0 transition-opacity duration-700 ease-in-out ${
          currentSlide === 2
      ...
      >
        ...
        {/* Mobile Slide 3 Overlay - Action buttons pinned to bottom without blocking top graphic */}
        ...
        {/* Desktop Slide 3 Overlay - Bottom Action Bar */}
