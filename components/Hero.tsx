  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Desktop Background Image (pressure washer Banner_ 3 Y.png) */}
        ...
        <div className="sm:hidden relative z-10 w-full h-full flex flex-col justify-end px-5 pb-10 pt-20">
          ...
          <div className="flex flex-col gap-2.5 mt-4 w-full">
            <button
              onClick={openModal}
              className="w-full inline-flex items-center justify-center gap-2 bg-[#0066cc] hover:bg-[#0052b3] text-white font-montserrat text-xs font-black tracking-wider uppercase py-3.5 rounded-[4px] shadow-xl shadow-blue-600/30 transition-all active:scale-[0.98] cursor-pointer"
            >
              <span>SHOP NOW</span>
        ...
        <div className="hidden sm:flex relative z-10 w-full px-6 sm:px-12 lg:px-16 xl:px-20 pt-28 pb-16 sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-28 h-full flex-col justify-center">
          <div className="max-w-[540px] lg:max-w-[620px] xl:max-w-[680px]">
            ...
            {/* Headline */}
            <h1 className="font-montserrat text-5xl sm:text-6xl md:text-7xl lg:text-[84px] xl:text-[96px] leading-[0.95] tracking-tight uppercase drop-shadow-[0_4px_24px_rgba(0,0,0,0.75)]">
              <span className="block font-black text-white">NO POWER.</span>
              <span className="block font-bold text-white/80">NO SOCKET.</span>
            </h1>

            {/* Description Paragraph */}
            <p className="font-open-sans text-white/90 mt-4 sm:mt-5 max-w-[480px] text-[14px] sm:text-[15.5px] leading-relaxed font-normal drop-shadow-[0_1px_4px_rgba(0,0,0,0.8)]">
              Wash your car anywhere with the AMEC Aquaforce 1400 - a powerful,
              battery-powered portable pressure washer. No cables, no power
              sockets, no fixed setup needed.
            </p>
      ...
      >
        ...
        {/* Desktop Background Image (pressure washer Banner_ 4Y.png) */}
        <div className="hidden sm:block absolute inset-0 z-0">
          <Image
            ...
            className="object-cover object-center"
          />
          {/* Subtle bottom dark gradient so bottom bar text and buttons are 100% crisp */}
        ...
        {/* Desktop Slide 3 Bottom Content Bar (Never Overlaps Center 'NO POWER. NO SOCKET.' Graphic) */}
      ...
      {/* ========================================================= */}
      {/* Carousel Controls: Navigation Indicators (3 Slides) */}
      {/* ========================================================= */}
