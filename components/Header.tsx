        ...
        <div className="md:hidden mt-2.5 max-w-7xl mx-auto bg-black/45 backdrop-blur-2xl border border-white/20 rounded-[14px] p-5 shadow-[0_20px_50px_rgba(0,0,0,0.6)] animate-in fade-in slide-in-from-top-2 duration-200">
          <nav className="flex flex-col gap-3">
            ...
            <button
              ...
              className="mt-2 w-full inline-flex items-center justify-center gap-2 bg-[#005DA6] hover:bg-[#004b87] text-white text-xs font-black tracking-wider uppercase px-5 py-3.5 rounded-[8px] shadow-lg shadow-blue-600/30 cursor-pointer active:scale-98 transition-all"
            >
              <span>SHOP NOW</span>
